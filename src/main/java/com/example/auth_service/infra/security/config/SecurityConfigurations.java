...
import com.example.auth_service.infra.security.filters.SecurityFilter;
...
public class SecurityConfigurations {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(List.of("http://localhost:5173")); // Permite solicitudes desde React
